                            ...
                            <div class="row m-l-0 m-r-0">
                                <div class="col-sm-4 bg-c-lite-green user-profile">
                                    <div class="card-block text-center text-white">
                                        <div class="m-b-25"> <img src="{{asset('public/'.$user->owner->image)}}" class="img-radius w-50 rounded-circle" alt="User-Profile-Image"> </div>
                                    ...
                                    <div class="card-block">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <h4 class="text-muted f-w-400">12</h4>
                                            </div>
                                            <div class="col-sm-6">
                                                <h3 class="m-b-10 f-w-600">الحواصل</h3>
                                                <h4 class="text-muted f-w-400">3</h4>
                                            </div>
                                        </div>
                                        <ul class="social-link list-unstyled m-t-40 m-b-10">
                                            <li><a href="{{$user->owner->facebook}}" title="" data-original-title="facebook" data-abc="true"><i class="fab fa-facebook h2"></i></a></li>
                                            <li><a href="{{$user->owner->twitter}}"  title="" data-original-title="twitter" data-abc="true"><i class="fab fa-twitter h2" style="color: rgb(29, 161, 242)"></i></a></li>
                                            <li><a href="{{$user->owner->instagram}}" title="" data-original-title="instagram" data-abc="true"><i class="fab fa-instagram h2"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
